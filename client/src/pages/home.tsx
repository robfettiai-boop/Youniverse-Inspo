  ...
  return (
    <div className="font-vogue bg-white min-h-screen flex flex-col items-center justify-center px-4 relative">
      ...
      <div className="absolute top-4 right-4 flex gap-4">
        <a 
          href="https://www.instagram.com/learnyourself.jp_?igsh=MWxtemNpOG5uNmpiZg%3D%3D&utm_source=qr" 
          target="_blank" 
        ...
        <a 
          href="https://rkb.jp/contents/202506/196213/" 
          target="_blank" 
          rel="noopener noreferrer"
      ...
      <div className="flex flex-col items-center justify-center space-y-16 max-w-4xl w-full">
        ...
        <div className="flex justify-center w-full">
          <p className="text-lg font-medium tracking-wide text-center shiny-text">
